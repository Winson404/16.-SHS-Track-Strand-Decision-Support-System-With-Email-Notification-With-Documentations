              ...
              <div class="col-lg-12 col-md-12">
                <div class="smsall-box bg-white p-3">
                  <div class="inner mt-3">
                    <img src="images/23.jpg" alt="" width="700" style="display: block;margin-left: auto;margin-right: auto;">
                  </div>
                  <h3 class="text-center mt-3"><b>Agri-fishery Arts</b></h3>
                  <br>
                  <p style="text-align: justify; font-size:140%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The <b>Agri-Fishery Arts</b> was designed for hands-on learning and application of skills that are related to agriculture and aquaculture. Students will be taking various subjects that are connected to other jobes such as food processing, rubber production, animal production, or landscape installation.</p>
                  <p class="mt-4 text-center" style="font-size:130%;"><a href="school_TVL-back-up.php">See Schools Offering Agri-fishery Arts</a></p>
                  <p class="mt-4 text-center" style="font-size:130%;"><a href="school_TVL.php">See Courses Related to Agri-fishery Arts</a></p>
                </div>
