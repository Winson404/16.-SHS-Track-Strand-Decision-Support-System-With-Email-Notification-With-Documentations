              ...
              <div class="col-lg-12 col-md-12">
                <div class="smsall-box bg-white p-3">
                  <div class="inner mt-3">
                    <img src="images/22.png" alt="" width="700" style="display: block;margin-left: auto;margin-right: auto;">
                  </div>
                  <h3 class="text-center mt-3"><b>Industrial Arts</b></h3>
                  <br>
                  <p style="text-align: justify; font-size:140%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Industrial Arts</b> helps students develop their technical skills. These skills are useful for industry jobs, including carpentry, automotive services, electronics, plumbing, welding, and many more. In fact, this strand aims to produce field experts skilled in various technical facets.</p>
                  <p class="mt-4 text-center" style="font-size:130%;"><a href="school_TVL-back-up.php">See Schools Offering Industrial Arts</a></p>
                  <p class="mt-4 text-center" style="font-size:130%;"><a href="school_TVL.php">See Courses Related to Industrial Arts</a></p>


                 
                </div>
                <div class="p-1  mt-5 mb-5">
                    <embed src="https://www.youtube.com/embed/2GhjbMmD56o" type="" style="width: 100%; height: 600px;">
                </div>
              </div> 
                <?php 
