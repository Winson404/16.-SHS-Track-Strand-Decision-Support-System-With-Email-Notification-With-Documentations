  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        <br>
        <h2 class="text-center mt-5" style="color: #17A2B8;"><b><u>Assessment for SHS Track</u></b></h2>
        <hr>
        <div class="row d-flex justify-content-center">
          <div class="col-lg-7  p-3 rounded" data-aos="fade-left" data-aos-delay="100" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px;">
