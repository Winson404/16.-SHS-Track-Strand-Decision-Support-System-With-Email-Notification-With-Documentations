...
<head>
  ...
  <title>SHS Track and Strand</title>
 ...
 -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">&nbsp;&nbsp;&nbsp;SHStudent</span><br>
      <span class="text-sm font-weight-light ml-5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Website visitors: </span><span class="badge bg-success text-sm"><?php echo $total_visitors; ?></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- <li class="nav-item">
            <a href="users.php" class="nav-link"><i class="fa-solid fa-users"></i><p>&nbsp;&nbsp; Users list</p></a>
          </li>
 -->

          <li class="nav-header text-secondary">SECURITY</li>
          <li class="nav-item">
            <a href="changepassword.php" class="nav-link"><i class="fa-solid fa-key"></i><p>&nbsp;&nbsp; Change password</p></a>
          </li>
