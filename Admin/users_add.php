  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header alert-info">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-user-plus"></i> Create user</h5>
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm"  placeholder="Middle name" name="middlename"  onkeyup="lettersOnly(this)">
            </div>
          </div>
          <div class="col-lg-3">
              <div class="form-group">
          ...
          <!-- <div class="col-lg-3">
               <div class="form-group">
                  <label>Contact</label>
                  <input type="number" class="form-control form-control-sm"  placeholder="9123456789" pattern="[7-9]{1}[0-9]{9}" name="contact" >
               </div>
          </div> -->
          <div class="col-auto form-group col-lg-3 form-control-sm">
              ...
              <div class="input-group">
                ...
                <input type="tel" class="form-control form-control-sm" pattern="[7-9]{1}[0-9]{9}" id="contact" name="contact" placeholder = "9123456789" maxlength="10">
              </div>
          </div>
          <div class="col-lg-4">
              <div class="form-group">
          ...
          <div class="col-lg-4">
              <div class="form-group">
                ...
                <input type="password" class="form-control form-control-sm"  placeholder="Password" name="password" required id="password" minlength="8" maxlength="16">
              </div>
          </div>
          <div class="col-lg-4">
              <div class="form-group">
                <label>Confirm password</label>
                <input type="password" class="form-control form-control-sm" placeholder="Confirm password" name="cpassword" required id="cpassword" onkeyup="validate_password()" minlength="8" maxlength="16">
          ...
          <div class="col-lg-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" placeholder="Barangay" name="Barangay" required>
              </div>
          </div>
          <div class="col-lg-4">
              <div class="form-group">
                <label>Municipality</label>
                <input type="text" class="form-control form-control-sm" placeholder="Municipality" name="Municipality" required>
              </div>
          </div>
          <div class="col-lg-4">
              <div class="form-group">
                <label>Province</label>
                <input type="text" class="form-control form-control-sm" placeholder="Province" name="Province" required >
              </div>
          </div>
          <div class="col-lg-4">
              <div class="form-group">
