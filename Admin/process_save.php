	...
	if(isset($_POST['create_admin'])) {
      ...
      $_SESSION['status'] = "error";
			header("Location: admin.php");
				  	...
				  	if(empty($file)) {
		              $save = mysqli_query($conn, "INSERT INTO users (firstname, middlename, lastname, suffix, gender, dob, age, barangay, municipality, province, email, contact, password, date_registered, user_type) VALUES ('$firstname', '$middlename', '$lastname', '$suffix', '$gender', '$dob', '$age', '$Barangay', '$Municipality', '$Province', '$email', '$contact', '$password', '$date_registered', '$usertype')");
                  ...
                  // if everything is ok, try to upload file
                      ...
                      if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                      	...
                      	$save = mysqli_query($conn, "INSERT INTO users (firstname, middlename, lastname, suffix, gender, dob, age, barangay, municipality, province, email, contact, password, image, date_registered, user_type) VALUES ('$firstname', '$middlename', '$lastname', '$suffix', '$gender', '$dob', '$age', '$Barangay', '$Municipality', '$Province', '$email', '$contact', '$password', '$file','$date_registered', '$usertype')");
