  ...
  <div class="content-wrapper">
    <section class="content">
      <div class="container-fluid">
          ...
          <h3 class="p-3 text-center text-info" style="text-decoration: underline;"><b>TVL RANKINGS BASED ON STUDENT'S ASSESSMENT RESULTS</b></h3>
           ...
           <div class="row d-flex justify-content-center">
                ...
                <!--  <div class="col-lg-10 mt-5">
                    <hr>
                    <h3 class="p-3 text-center text-info" style="text-decoration: underline;"><b>List of students who chose TVL Track</b></h3>
                   <div class="card-body">
                      <table id="example2" class="table table-bordered table-striped">
                        ...
                        <tbody id="users_data">
                          <tr>
                            <?php 
                            //  $sql = mysqli_query($conn, "SELECT * FROM users JOIN tvl_strand_sort ON users.user_Id=tvl_strand_sort.user_Id GROUP BY //strand_answer, users.user_Id");
