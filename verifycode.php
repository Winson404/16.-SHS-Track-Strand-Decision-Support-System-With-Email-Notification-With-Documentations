      ...
      if(mysqli_num_rows($fetch) > 0) {
          ...
          if($check_code == NULL) {
                ...
                if($insert_code) {
                    ...
                    <p>You can change your password by just clicking it <a href="http://localhost/PROJECT%2019.%20SHS%20Track%20&%20Strand%20Desicion%20Support%20System/changepassword2.php?user_Id='.$user_Id.'&&email='.$email.'&&key='.$code.'">here!</a></p> 
                        ...
                        <?php } // CLOSING TAG IF CODE IS NULL
                              ...
                              if($update_code) {
                                 ...
                                 ?>
                                          ...
                                          } // CLOSING TAG - IF UPDATE CODE IS TRUE
                                          else { ?>
                                                   <div class="card card-outline card-primary">
                                                      <div class="card-header text-center">
                                                        <a href="#" class="h1"><b>500 ERROR</b></a>
                                        ...
                                        <?php }
                                          } // CLOSING IF ELSE STATEMENT IF VERIFICATION CODE IS NOT NULL
