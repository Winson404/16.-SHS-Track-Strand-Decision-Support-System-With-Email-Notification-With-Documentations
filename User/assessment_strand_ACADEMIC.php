<title>SHStudent | STRAND ASSESSMENT</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Academic Track Assessment</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
             <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Academic Track Assessment</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="card card-info">
              <div class="card-header">
                ...
                <form class="p-3" action="process_save.php" method="POST">
                    ...
                    <h3>Take Academic track assessment:</h3>
                    <hr>
